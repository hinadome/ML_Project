...
- Docker Instance
  ```
  docker run -p 8000:8000 instances_prediction_model:v1
  ```
# Application
- Test Request
  ```
  ...
  ```
  curl -X 'POST' \
  'http://localhost:8000/predict-scaling_on_xgb' \
  -H 'accept: application/json' \
  -H 'Content-Type: application/json' \
  -d '{
  "history": [
   ...
   curl -X 'POST' \
  'http://localhost:8000/predict-scaling_on_gbr' \
  -H 'accept: application/json' \
  -H 'Content-Type: application/json' \
  -d '{
  "history": [
  ...
  ```
   curl -X 'POST' \
  'http://localhost:8000/predict-scaling-smart-gbr' \
  -H 'accept: application/json' \
  -H 'Content-Type: application/json' \
  -d '{
  "history": [
  ...
  ```
  curl -X 'POST' \
  'http://localhost:8000/predict-scaling-smart-xgb' \
  -H 'accept: application/json' \
  -H 'Content-Type: application/json' \
  -d '{
  "history": [
  ...
  ```
- CloudRun Test HostName: scalingpredict-402889997289.us-west1.run.app
  ```
  curl -X 'POST' \
